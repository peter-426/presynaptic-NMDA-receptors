...
static constexpr double nv=1;  // max number of docked vesicles that can be released per AP;  also see Nikonenko & Skibo (2006)
static constexpr double gv=60; // 60; // Glutamate concentration in single vesicle;  mM; Montana et al. (2006)
static constexpr double degG=10; //10 Extracellular glutamate degradation rate; per ms; p4 Destexhe et al (1998)
...
static constexpr double tau_inact=3;  // Vesicle inactivation time constant; ms; Tsodyks & Markram (1997)
