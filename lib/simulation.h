...
#ifndef _bouton_h_included_
#define _bouton_h_included_
#include "bouton.h"
#endif

#ifndef _save_h_included_
#define _save_h_included_
#include "save.h"
#endif

#ifndef _spine_h_included_
#define _spine_h_included_
#include "spine.h"
#endif

#ifndef _astrocyte_h_included_
#define _astrocyte_h_included_
#include "astrocyte.h"
#endif
...
{    
  ...
  {   
      srand(6); // 13 --> .32   .35 
      //srand(time(NULL)); //to generate a different seq of rand values every time. 
      totalRate = 0;
...
//       }     
    ...
    else
    {
     ...
     if (save_data)
     {
        ...
        if ( ! BLOCKER)  
        {   
           save_acsf(A, S, B, pr_ACSF_barChart, pr_ACSF_barChart_raw, ex);     
        }
        else  
        {            
