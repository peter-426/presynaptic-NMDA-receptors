...
#ifndef _spine_receptors_h_included_
#define _spine_receptors_h_included_
#include "spine_receptors.h"
#endif
...
static constexpr double tau_mem=50;      // Post-synaptic membr time constexprant; ms; Tsodyks & Markram (1997)
static constexpr double rad_spine=0.6e-4;  // Radius of spine-head; cm; Dumitriu et al (2010)

double vspine;  // Volume of spine-head; unit: L; Calculated
double sspine;  // Surface area of spine-head; unit: cm^2; Calculated

static constexpr double Vrest=-70;  // Resting membrane potential of spine membrane; unit: mV
