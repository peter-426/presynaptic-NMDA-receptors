...
static constexpr double nv=2;  // Number of docked vesicles; nv=2 in Nikonenko & Skibo (2006)
...
static constexpr double kon=0.3;  // Calcium binding rate to vesicle; 0.3 /uM /ms in Bollman et al (2000)
                               
static constexpr double koff=3.0;  // Calcium dissociation rate from vesicle;  3 per ms in Bollman et al (2000)
                               // Note:  Kd = koff/kon = 10uM or 10,000 nM
static constexpr double Gamma=30;
static constexpr double delta=8;  // Isomerization constexprants;  per ms;   Bollman et al (2000)
